...
namespace SchetsEditor.Historie
{
    class TekstObject : ISchetsObject
    {
        ...
        public bool RaaktCirkel(Point locatiegum, int radius)
        {
            ...
            return (locatiegum.X + radius < locatie.X && locatiegum.X - radius < locatie.X + oppervlakte.Width
                && locatiegum.Y + radius < locatie.Y && locatiegum.Y - radius < locatie.Y + oppervlakte.Height);
        }
